...
public class Shejiao_Class_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.child_shejiao_class);
        initView();
    }
//    @Override
...
//    }
    private void initView(){
        Class_VP=(ViewPager)findViewById(R.id.shejiao_class_viewpager);
        mClass=(TextView) findViewById(R.id.class_name);
        mMark_one=(TextView) findViewById(R.id.class_one);
        mMark_date=(TextView) findViewById(R.id.class_date);
        ...
        View v1=layoutInflater.inflate(R.layout.son_class_one,null);
        View v2=layoutInflater.inflate(R.layout.son_class_date,null);

        final ArrayList<View> views=new ArrayList<>();
        views.add(v1);
        views.add(v2);

        ListView listView1=(ListView) v1.findViewById(R.id.class_o);
        ListView listView2=(ListView) v2.findViewById(R.id.class_d);

        Class_VP.setAdapter(new ViewPagerAdapter(views));
        ...
        Request request=new Request.Builder()
                .url("http://101.132.163.184/api/user/marks/class/")
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(@NonNull Call call, @NonNull IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(Shejiao_Class_Activity.this, "网络请求失败", Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    }
                });
            }
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                if(response.isSuccessful()){
                    ...
                    try {
                        ...
                        ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(Shejiao_Class_Activity.this,R.layout.item,titleList1);
                        ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(Shejiao_Class_Activity.this,R.layout.item,titleList2);
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                        ...
                        listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                Intent intent = new Intent(Shejiao_Class_Activity.this, Item_Mark_Activity.class);
                        ...
                        listView2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                // 创建一个Intent对象，指定当前Activity和目标Activity
                                Intent intent = new Intent(Shejiao_Class_Activity.this, Item_Mark_D_Activity.class);
                                // 将数据放入Intent中，使用putExtra方法
                                intent.putExtra("selectedtitle", selectedtitle);
                                intent.putExtra("selectedcontent",selectedcontent);
                                intent.putExtra("selectedkind",selectedkind);
