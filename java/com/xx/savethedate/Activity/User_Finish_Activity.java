...
public class User_Finish_Activity extends AppCompatActivity {
    private TextView mClass;
    private TextView mMark_one;
    private TextView mMark_date;
    private ViewPager Finish_VP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.son_user_finished);
        initView();
    }
    private void initView(){
        Finish_VP=(ViewPager)findViewById(R.id.user_finished_viewpager);
        mClass=(TextView) findViewById(R.id.finish_name);
        mMark_one=(TextView) findViewById(R.id.finished_one);
        mMark_date=(TextView) findViewById(R.id.finished_date);
        ...
        View v1=layoutInflater.inflate(R.layout.son_finished_o,null);
        View v2=layoutInflater.inflate(R.layout.son_finished_date,null);

        final ArrayList<View> views=new ArrayList<>();
        views.add(v1);
        views.add(v2);

        ListView listView1=(ListView) v1.findViewById(R.id.finished_o);
        ListView listView2=(ListView) v2.findViewById(R.id.finished_d);

        Finish_VP.setAdapter(new ViewPagerAdapter(views));
        ...
        Request request=new Request.Builder()
                .url("http://101.132.163.184/api/user/marks/finished/")
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(@NonNull Call call, @NonNull IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(User_Finish_Activity.this, "网络请求失败", Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    }
                });
            }
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                if(response.isSuccessful()){
                    ...
                    try {
                        ...
                        ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(User_Finish_Activity.this,R.layout.item,titleList1);
                        ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(User_Finish_Activity.this,R.layout.item,titleList2);
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                        ...
                        listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                String selectedmarkid=markidList1.get(position);

                                // 创建一个Intent对象，指定当前Activity和目标Activity
                                Intent intent = new Intent(User_Finish_Activity.this, Item_Mark_P_O_Activity.class);
                        ...
                        listView2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                String selectedmarkid=markidList2.get(position);
                                // 创建一个Intent对象，指定当前Activity和目标Activity
                                Intent intent = new Intent(User_Finish_Activity.this, Item_Mark_P_D_Activity.class);
                                // 将数据放入Intent中，使用putExtra方法
                                intent.putExtra("selectedtitle", selectedtitle);
                                intent.putExtra("selectedcontent",selectedcontent);
                                intent.putExtra("selectedkind",selectedkind);
    ...
    public class MyOnClickListener implements View.OnClickListener{
        ...
        public void onClick(View view) {
            Finish_VP.setCurrentItem(index);
        }
    }
