...
public class Item_Mark_FD_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_user_mark_content_date);
        initview();
    }
    @Override
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(@NonNull Call call, @NonNull IOException e) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(Item_Mark_FD_Activity.this, "网络请求失败", Toast.LENGTH_SHORT).show();
                        //e.printStackTrace();
                    }
                });
            }
                ...
                try {
                    ...
                    if("success".equals(errorMessage)){
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(Item_Mark_FD_Activity.this, "收录成功", Toast.LENGTH_SHORT).show();
                                //e.printStackTrace();
                            }
                        });
                    }
    ...
    public void initview(){
        ...
        mfinish=(Button)findViewById(R.id.firstButton);
